                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="pull-left">
                                                    ...
                                                    <br>
                                                    <div class="dropdown">
                                                        <label>Product Category</label>&nbsp &nbsp &nbsp
                                                        <select id="productCategory" class="btn btn-default dropdown-toggle" >
                                                            <option value=""></option>
                                                            <option value="Biscuits">Biscuits</option>
                                                            <option value="Chocolate">Chocolate</option>
                                                            <option value="Cakes">Cakes</option>
                                                            <option value="Cerials">Soya</option>
                                                            <option value="Herbal">Matara</option>
                                                            <option value="Snacks">Kandy</option>
                                                        </select>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <label>Weight</label>
                                                    <input id="productWeight" type="text" class="form-control" placeholder="Enter Weight" value="">
                                                    <br>
                                                    <label>Product Name</label>
                                                    <input id="productName" type="text" class="form-control" placeholder="Enter Product Name" value="">
                                                    <br>
                                                    <label>Profit per unit</label>
                                                    <input id="productProfit" type="text" class="form-control" placeholder="Enter Duration" value="">
                                                    <br>
                                                    <label>Status</label>
                                                    <div class="dropdown">
                                                        <select id="productStatus" class="btn btn-default dropdown-toggle" >
                        ...
                        <div class="card card-user">
                            <div class="content">
                                <div class="pull-center">
                                    ...
                                    <input type="text" id="searchProductId" class="form-control" placeholder="TYPE YOUR PRODUCT ID HERE" name="search"><br>
