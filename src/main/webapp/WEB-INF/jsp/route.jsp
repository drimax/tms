                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="pull-left">
                                                    ...
                                                    <input id="routeName" type="text" class="form-control" placeholder="Enter user name" value="">
                                                    <br>
                                                    <div class="dropdown">
                                                        <label>Origin</label>&nbsp &nbsp &nbsp
                                                    ...
                                                    <br>
                                                    <div class="dropdown">
                                                        <label>Destination</label>&nbsp &nbsp &nbsp
                                                    ...
                                                    <input id="routeDistance" type="text" class="form-control" placeholder="Enter Distance" value="">
                                                    <br>
                                                    <label>Duration</label>
                                                    <input id="routeDuration" type="text" class="form-control" placeholder="Enter Duration" value="">
                                                    <br>
                                                    <label>Status</label>
                                                    <div class="dropdown">
                        ...
                        <div class="card card-user">
                            <div class="content">
                                <div class="pull-center">
                                    ...
                                    <input type="text" id="searchRouteId" class="form-control" placeholder="TYPE YOUR ROUTE ID HERE" name="search"><br>
                                ...
                                <div class="content table-responsive table-full-width">
                                    ...
                                    <div class="pull-center">
                                        ...
                                        <button type="submit" id="routeUpdateButton" onclick="routeUpdate()" class="btn btn-info btn-fill pull-center">Edit</button>&nbsp &nbsp &nbsp
